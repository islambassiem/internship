<x-layouts.auth>
    ...
    <form action="{{ route('password.update') }}" method="post">
        ...
        <div class="mx-5 text-gray-500 text-sm mb-2">
                ...
                <ul>
                    @foreach ($errors->all() as $error)
                        <div id="alert-border-2"
                            class="flex items-center p-4 text-red-800 border-t-4 border-red-300 bg-red-50 dark:text-red-400 dark:bg-gray-800 dark:border-red-800 mx-5"
                            role="alert">
        ...
        <div class="my-10 w-full text-center">
            <x-auth.button title="Change Password"> </x-auth.button>
        </div>
